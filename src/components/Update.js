...
class Update extends React.Component {
    ...
    componentWillMount() {
        ...
        Object.keys(this.props.pdata).map(key => 
            this.setState({ [key]: this.props.pdata[key]})
        );
    }
    ...
    render() {
        return (
            <div>
                <Button onClick={this.openModal} style={{backgroundColor: '#3A8FDA', borderStyle: 'none'}}>
                    <span className="fa fa-edit" style={{color:'white', verticalAlign: 'middle'}}></span></Button>
                <Modal
                    ...
                    className="Modal">
                        ...
                        <fieldset>
                            ...
                            <label htmlFor="barcode">Bar Code:</label><input type="text" id="barcode" name="barcode" value={this.state.barcode} onChange={this.handleTextChange}></input>
                        ...
                        <div className='button-center'>
                            <br/>
                            <Button bsStyle="success" bsSize="large" onClick={this.onClick} style={{height: '30px', fontWeight: 'bold', backgroundColor: '#3A8FDA', color: 'white', borderStyle: 'none'}}>Update Product</Button>
                        </div>
                </Modal>
            </div>
        )
